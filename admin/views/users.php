...
<?php if($option!="com_users_insert"){ ?>
<div class="site_rgt">
                ...
                <div class="content_blg">
                    ...
                    <div class="title_blg">
                    	<ul>
                            ...
                            <li><a href="index.php?option=com_users">User Management</a></li>
                            <li><a href="#"><img src="images/title_pics_22.png" alt=""></a></li>
                            <li><a href="index.php?option=com_users">Users</a></li>
                        </ul>
                    </div><!--title_blg-->
                    ...
                    <div class="customer-list">
                     ...
                     <div class="paginationwrap">page 
                       ...
                       <span class="padding_wrap1">
                           ...
                           <script type="text/javascript">
							...
							{	
								...
								{
								window.location.assign('index.php?option=com_users&limit='+<?php echo $limit;?>+'&start='+start+'&pagno='+c);
								}}
								else
								{
								...
								window.location.assign('index.php?option=com_users&limit='+<?php echo $limit;?>+'&start='+start+'&pagnos='+c);	}
								}
							}			
                            </script>
                       </span>
					   <script>
					   function showdata(a) {
					   window.location.assign('index.php?option=com_users&limit='+a);
					   }
					   </script>
                       
                       <span class="padding_wrap">records | Found total <?php echo $totalrecords; ?> records</span>
                       <span class="padding_wrap" style="float:right; margin-top:10px"><a href="index.php?option=com_users_insert"><img src="images/add-btn_03.png" /></a></span>
                        <div class="clear_fix"></div>
                     </div><!--paginationwrap-->
                     ...
                     <div class="table_wrap1">
                       <div class="tableheading1">
                         ...
                         <div class="staffname">Staff Names</div>
                         <div class="staffemail">Staff Id</div>
                         <div class="staffphoneno">Profile Image</div>
                    ...
                    ?>
                        <li>
                         ...
                         <div class="staffname1"><span>Staff Names</span><?php echo $all_pages->staffname;?></div>
                         <div class="staffemail1"><span>Staff Id</span><?php echo $all_pages->staffid;?></div>
                         <div class="staffphoneno1"><span>Profile Image</span><img src="../uploads/Staff/thumbs/<?php echo $all_pages->profileimage;?>"></div>
                         <div class="staffgender1"><span>Status</span><?php echo $all_pages->status;?></div>
                         <div class="staffedit1"><span>Edit</span>
                         <a href="index.php?option=com_users_insert&id=<?php echo $all_pages->id;?>"><img src="images/edit-delete_09.png"></a></div>
                         <div class="staffdelete1" onClick="var q = confirm('Are you sure you want to delete selected record?'); if (q) { window.location = 'index.php?option=com_users&action=delete&id=<?php echo $all_pages->id;?>'; return false;}"><span>Delete</span><img src="images/edit-delete_06.png" style="cursor: pointer;"></div>
                         <div class="clear_fix"></div>
                        </li>
					<?php $ii++;}}else{	?>
                ...
                <div class="content_blg">
                    ...
                    <div class="title_blg">
                    	<ul>
                            ...
                            <li><a href="index.php?option=com_dashboard">Home</a></li>
                            <li><a href="#"><img src="images/title_pics_22.png" alt=""></a></li>
                            <li><a href="index.php?option=com_users"> Staff Management  </a></li>
                            <li><a href="#"><img src="images/title_pics_22.png" alt=""></a></li>
                            <li><a href="#"> Add/Edit Staff </a></li>
                        </ul>
                    </div><!--title_blg-->
                    ...
                    <div class="add_product_blg">
                       ...
                       <div class="add_product_blg_btm">
                        ...
                        <?php
						$query="SELECT staffid FROM tb_staff ORDER BY id DESC LIMIT 1";
                        $result=mysql_query($query);
						$row=mysql_fetch_assoc($result);
						$skuid = substr($row['staffid'],3,8);
						$sku="STF".($skuid+1);
						?>
                        
                        <div class="add_product_blg_btm_rgt">
                        	<input type="text" name="productskuid" readonly="readonly" value="<?php if($indivdata->id!=''){ echo $indivdata->staffid;}else{echo $sku;}?>">
                       ...
                       <div class="add_product_blg_btm">
                        ...
                        <div class="add_product_blg_btm_rgt">
                        	<input type="text" name="email" value="<?php echo $indivdata->email;?>">
                        </div><!--add_product_blg_btm_rgt-->
                       </div>
                       ...
                       <div class="add_product_blg_btm">
                        ...
                        <div class="add_product_blg_btm_rgt">
                        	<input type="password" name="paswrd" value="<?php echo $callConfig->passwordDecrypt($indivdata->paswrd);?>">
                        </div><!--add_product_blg_btm_rgt-->
                       </div><!--add_product_blg_btm-->
                       ...
                       <div class="add_product_blg_btm">
                        ...
                        <div class="add_product_blg_btm_rgt">
							...
							<?php if($indivdata->profileimage!=""){?>
                                <img src="../uploads/Staff/<?php echo $indivdata->profileimage; ?>" width="50" height="50"/>
                                <input type="hidden" name="hdn_image" size="24" value="<?php echo $indivdata->profileimage; ?>" />
                            <?php } ?>
                        </div><!--add_product_blg_btm_rgt-->
                       </div><!--add_product_blg_btm-->
