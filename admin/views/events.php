...
if($_POST['admininsert']=="Save")
{
	...
	//print_r($_POST);
	//echo "<pre>";exit;
   $eventObj->insertcontentPage($_POST); 
}

if($_POST['admininsert']=="Update")
{

   $eventObj->updatecontentPage($_POST);
...
if(isset($_GET['id']) && $_GET['id']!="")
{
   ...
   $indivdata=$eventObj->getContentPageData($_GET['id']); 
   //print_r($indivdata);
...
{
//echo "syam";exit;
   $eventObj->contentpageDelete($_GET['id']);
...
$allpages=$eventObj->getAllContentPagesList($fiild,$ordby,$start,$limit);
//print_r($allpages);

$total=$eventObj->getAllContentPagesListCount();

?>

<?php if($option!="com_events_insert"){ ?>
<div class="site_rgt">
                ...
                <div class="content_blg">
                	<div class="page_name_blg">
                        ...
                        <div class="page_name_rgt">
                        	<a href="index.php?option=com_events"><img src="images/settng_pic_14.png" alt=""></a>
                        </div><!--page_name_rgt-->
                    </div><!--page_name_blg-->
                    <div class="title_blg">
                    	<ul>
                            ...
                            <li><a href="index.php?option=com_events">Events Management</a></li>
                            <li><a href="#"><img src="images/title_pics_22.png" alt=""></a></li>
                    ...
                    <div class="customer-list">
                     ...
                     <div class="paginationwrap">page 
                       ...
                       <span class="padding_wrap1">
                           ...
                           <script type="text/javascript">
							...
							{	
								...
								{
								window.location.assign('index.php?option=com_events&limit='+<?php echo $limit;?>+'&start='+start+'&pagno='+c);
								}}
								else
								{
								...
								window.location.assign('index.php?option=com_events&limit='+<?php echo $limit;?>+'&start='+start+'&pagnos='+c);	}
								}
							}			
                            </script>
                       </span>
					   <script>
					   function showdata(a) {
					   window.location.assign('index.php?option=com_events&limit='+a);
					   }
					   </script>
                       
                       <span class="padding_wrap">records | Found total <?php echo $totalrecords; ?> records</span>
                       <span class="padding_wrap" style="float:right; margin-top:10px"><a href="index.php?option=com_events_insert"><img src="images/add-btn_03.png" /></a></span>
                        <div class="clear_fix"></div>
                     </div><!--paginationwrap-->
                     ...
                     <div class="table_wrap1">
                       <div class="tableheading1">
                         ...
                         <div class="staffname">Event Name</div>
                         <div class="staffemail">Posted Date</div>
                         <div class="staffphoneno">Event Image</div>
                    ...
                    ?>
                        <li>
                         ...
                         <div class="staffname1"><span>Event Name</span><?php echo $all_pages->title;?></div>
                         <div class="staffemail1"><span>Posted Date</span><?php echo $all_pages->posteddate;?></div>
							 <div class="staffphoneno1"><span>Event Image</span><img src="../uploads/events/<?php echo $all_pages->image; ?>" width="100" height="50" style="padding:5px;" /></div>
                         <div class="staffgender1"><span>Status</span><?php echo $all_pages->status;?></div>
                         <div class="staffedit1"><span>Edit</span>
                         <a href="index.php?option=com_events_insert&id=<?php echo $all_pages->id;?>"><img src="images/edit-delete_09.png"></a></div>
                         <div class="staffdelete1" onClick="var q = confirm('Are you sure you want to delete selected record?'); if (q) { window.location = 'index.php?option=com_events&action=delete&id=<?php echo $all_pages->id;?>'; return false;}"><span>Delete</span><img src="images/edit-delete_06.png" style="cursor: pointer;"></div>
                         <div class="clear_fix"></div>
                        </li>
					<?php $ii++;}}else{	?>
		
								<li>No Event Records..</li>
					<?php 
					}
					?>
                ...
                <div class="content_blg">
                    ...
                    <div class="add_product_blg">
                       ...
                       <div class="add_product_blg_btm">
                        ...
                        <div class="add_product_blg_btm_rgt">
                        	<input type="text" name="posteddate"  value="<?php echo $indivdata->edate;?>">
					   ...
					   <div class="add_product_blg_btm">
                        ...
                        <div class="add_product_blg_btm_rgt">
							...
							<?php if($indivdata->image!=""){?>
                                <img src="../uploads/events/<?php echo $indivdata->image; ?>" width="150" height="150"/>
                       ...
                       <div class="add_product_blg_btm">
						...
						<!--	<textarea name="description"><?php echo $indivdata->description;?></textarea>-->
							   <textarea  name="description" id="descr" class="ckeditor"><?php echo $indivdata->bigtext; ?></textarea>
                        </div><!--add_product_blg_btm_rgt-->
                       </div><!--add_product_blg_btm-->
