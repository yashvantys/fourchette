...
//print_r($_GET['id']); exit;
   $faqObj->contentpageDelete($_GET['id']);
...
$allpages=$faqObj->getAllfaqList($fiild,$ordby,$start,$limit);
//print_r($allpages);

 $total=$faqObj->getAllfaqListCount();

?>

<?php if($option!="com_faqs_insert"){ ?>
<div class="site_rgt">
                ...
                <div class="content_blg">
                    ...
                    <div class="title_blg">
                    	<ul>
                            ...
                            <li><a href="index.php?option=com_faqs">FAQ's Management</a></li>
                            <li><a href="#"><img src="images/title_pics_22.png" alt=""></a></li>
                            <li><a href="#">Faq</a></li>
                        </ul>
                    </div><!--title_blg-->
                    ...
                    <div class="customer-list">
                     ...
                     <div class="paginationwrap">page 
                       ...
                       <span class="padding_wrap1">
                           ...
                           <script type="text/javascript">
							...
							{	
								...
								{
								window.location.assign('index.php?option=com_faqs&limit='+<?php echo $limit;?>+'&start='+start+'&pagno='+c);
								}}
								else
								{
								...
								window.location.assign('index.php?option=com_faqs&limit='+<?php echo $limit;?>+'&start='+start+'&pagnos='+c);	}
								}
							}			
                            </script>
                       </span>
					   <script>
					   function showdata(a) {
					   window.location.assign('index.php?option=com_faqs&limit='+a);
					   }
					   </script>
                       
                       
                       <span class="padding_wrap">records | Found total <?php echo $totalrecords; ?> records</span>
                       <span class="padding_wrap" style="float:right; margin-top:10px"><a href="index.php?option=com_faqs_insert"><img src="images/add-btn_03.png" /></a></span>
                        <div class="clear_fix"></div>
                     </div><!--paginationwrap-->
                     ...
                     <div class="table_wrap1">
                       <div class="tableheading1">
                         ...
                         <div class="customerproname">Question</div>
                        
                         <div class="customerprodiscs">Answer</div>
                    ...
                    ?>
                        <li>
                         ...
                         <div class="customerproname1"><span>Title</span><?php echo $all_pages->question;?> </div>
                         <div class="customerprodisc2"><span>Description</span><?php echo substr($all_pages->answer,0,120);?><?php if($all_pages->answer!='') { ?>....<?php } ?></div>
                         <div class="customerprostatus1"><span>Status</span><?php echo $all_pages->status;?></div>
                         <div class="customerproedit1"><a href="index.php?option=com_faqs_insert&id=<?php echo $all_pages->id;?>"><span>Edit</span><img src="images/edit-delete_09.png"></a></div>
                         <div class="customerprodelete1" onClick="var q = confirm('Are you sure you want to delete selected record?'); if (q) { window.location = 'index.php?option=com_faqs&action=delete&id=<?php echo $all_pages->id;?>'; return false;}"><span>Delete</span><img src="images/edit-delete_06.png" style="cursor: pointer;"></div>
                         <div class="clear_fix"></div>
                        </li>
					<?php $ii++;}}else{	?>
...
<div class="site_rgt">
                ...
                <div class="content_blg">
                    ...
                    <form action="index.php?option=com_faqs_insert" method="post" id="frmCreateListing" name="frmCreateListing" class="middle_form" onSubmit="return validate();"  enctype="multipart/form-data">
                    <div class="add_product_blg">
                       ...
                       <div class="add_product_blg_btm">
                        ...
                        <div class="add_product_blg_btm_rgt">
                        	<input type="text" name="question" value="<?php echo $indivdata->question;?>">
                    ...
                    <!--   <div class="add_product_blg_btm">
                        ...
                        <div class="add_product_blg_btm_rgt">
                        <textarea  name="answer" id="answer" class="ckeditor"><?php echo $indivdata->answer; ?></textarea>
                        </div><!--add_product_blg_btm_rgt-->
                       </div><!--add_product_blg_btm-->
